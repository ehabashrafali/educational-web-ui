    ...
    children: [
      {
        ...
        loadChildren: () =>
          import("app/modules/create-instructor/create-instructor.routes"),
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        loadChildren: () =>
          import("app/modules/instructors-list/instructors-list.routes"),
      },
    ],
  },
  {
    ...
    children: [
      {
        path: "edit-report",
        loadChildren: () =>
          import("app/modules/edit-student-report/edit-student-report.routes"),
      },
    ],
  },
];
