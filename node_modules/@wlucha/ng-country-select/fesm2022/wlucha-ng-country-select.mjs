...
class CountrySelectComponent {
    ...
    filterCountries(value) {
        ...
        const filteredCountries = this.countries.filter(country => {
            const matchesCode = country.alpha2.toLowerCase().includes(filterValue) ||
                country.alpha3.toLowerCase().includes(filterValue);
            const matchesTranslation = this.searchAllLanguages
                ? Object.values(country.translations).some(t => t.toLowerCase().includes(filterValue))
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.1.5", ngImport: i0, type: CountrySelectComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "19.1.5", type: CountrySelectComponent, isStandalone: true, selector: "ng-country-select", inputs: { defaultCountry: "defaultCountry", lang: "lang", searchAllLanguages: "searchAllLanguages", placeholder: "placeholder", selectedCountry: "selectedCountry", selectedCountryByAlpha2: "selectedCountryByAlpha2", selectedCountryByAlpha3: "selectedCountryByAlpha3", selectedCountryByCurrentTranslation: "selectedCountryByCurrentTranslation", formControl: "formControl", debounceTime: "debounceTime", appearance: "appearance", color: "color", disabled: "disabled", required: "required", requiredErrorMessage: "requiredErrorMessage", showRequiredErrorMessage: "showRequiredErrorMessage", showCodes: "showCodes", includeCountries: "includeCountries", excludeCountries: "excludeCountries", alpha2Only: "alpha2Only", alpha3Only: "alpha3Only", showFlag: "showFlag" }, outputs: { countrySelected: "countrySelected", inputChanged: "inputChanged", closed: "closed" }, providers: [
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(() => CountrySelectComponent),
                multi: true
            }
        ], ngImport: i0, template: "<mat-form-field [appearance]=\"appearance\" [color]=\"color\">\n  <mat-label>{{ placeholder }}</mat-label>\n  <input matInput [formControl]=\"formControl\" [matAutocomplete]=\"auto\" [disabled]=\"disabled\" [required]=\"required\">\n  @if (showFlag === true) {\n  <mat-icon matSuffix class=\"flag-suffix fi\" [ngClass]=\"'fi-' + formControl.value?.alpha2\"></mat-icon>\n  }\n\n  @if (showRequiredErrorMessage && !isFieldValid()) {\n  <mat-error>\n    {{ requiredErrorMessage }}\n  </mat-error>\n  }\n\n  <mat-autocomplete #auto=\"matAutocomplete\" [displayWith]=\"displayFn.bind(this)\"\n    (optionSelected)=\"onOptionSelected($event.option.value)\" (closed)=\"onAutocompleteClosed()\">\n    <cdk-virtual-scroll-viewport [itemSize]=\"'25'\" [ngStyle]=\"{'height': height}\">\n      <mat-option *cdkVirtualFor=\"let country of filteredCountries$ | async; trackBy: trackByAlpha2\" [value]=\"country\">\n        <div class=\"country-option\">\n          @if (showFlag === true) {\n          <span class=\"flag fi\" [ngClass]=\"'fi-' + country?.alpha2\"></span>\n          }\n          @if (alpha2Only === true) {\n          <span class=\"name\">{{ country.alpha2 | uppercase }}</span>\n          } @else if (alpha3Only === true) {\n          <span class=\"name\">{{ country.alpha3 | uppercase }}</span>\n          } @else {\n          <span class=\"name\">{{ country.translations[lang] }}</span>\n          <span *ngIf=\"showCodes\" class=\"codes\">\n            ({{ country.alpha2 | uppercase }} / {{ country.alpha3 | uppercase }})\n          </span>\n          }\n        </div>\n      </mat-option>\n    </cdk-virtual-scroll-viewport>\n  </mat-autocomplete>\n</mat-form-field>", styles: [".country-option{display:flex;align-items:center;gap:8px}.country-option .flag,.flag-suffix{font-size:1em;display:inline;margin-right:10px}.codes{margin-left:auto;font-size:.9em;color:#666}.codes :empty{display:none}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "directive", type: i1.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }, { kind: "pipe", type: i1.AsyncPipe, name: "async" }, { kind: "pipe", type: i1.UpperCasePipe, name: "uppercase" }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i2.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i2.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i2.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { kind: "directive", type: i2.FormControlDirective, selector: "[formControl]", inputs: ["formControl", "disabled", "ngModel"], outputs: ["ngModelChange"], exportAs: ["ngForm"] }, { kind: "ngmodule", type: MatAutocompleteModule }, { kind: "component", type: i3.MatAutocomplete, selector: "mat-autocomplete", inputs: ["aria-label", "aria-labelledby", "displayWith", "autoActiveFirstOption", "autoSelectActiveOption", "requireSelection", "panelWidth", "disableRipple", "class", "hideSingleSelectionIndicator"], outputs: ["optionSelected", "opened", "closed", "optionActivated"], exportAs: ["matAutocomplete"] }, { kind: "component", type: i4.MatOption, selector: "mat-option", inputs: ["value", "id", "disabled"], outputs: ["onSelectionChange"], exportAs: ["matOption"] }, { kind: "directive", type: i3.MatAutocompleteTrigger, selector: "input[matAutocomplete], textarea[matAutocomplete]", inputs: ["matAutocomplete", "matAutocompletePosition", "matAutocompleteConnectedTo", "autocomplete", "matAutocompleteDisabled"], exportAs: ["matAutocompleteTrigger"] }, { kind: "ngmodule", type: MatInputModule }, { kind: "directive", type: i5.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["disabled", "id", "placeholder", "name", "required", "type", "errorStateMatcher", "aria-describedby", "value", "readonly", "disabledInteractive"], exportAs: ["matInput"] }, { kind: "component", type: i6.MatFormField, selector: "mat-form-field", inputs: ["hideRequiredMarker", "color", "floatLabel", "appearance", "subscriptSizing", "hintLabel"], exportAs: ["matFormField"] }, { kind: "directive", type: i6.MatLabel, selector: "mat-label" }, { kind: "directive", type: i6.MatError, selector: "mat-error, [matError]", inputs: ["id"] }, { kind: "directive", type: i6.MatSuffix, selector: "[matSuffix], [matIconSuffix], [matTextSuffix]", inputs: ["matTextSuffix"] }, { kind: "ngmodule", type: MatFormFieldModule }, { kind: "ngmodule", type: MatIconModule }, { kind: "component", type: i7.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "ngmodule", type: ScrollingModule }, { kind: "directive", type: i8.CdkFixedSizeVirtualScroll, selector: "cdk-virtual-scroll-viewport[itemSize]", inputs: ["itemSize", "minBufferPx", "maxBufferPx"] }, { kind: "directive", type: i8.CdkVirtualForOf, selector: "[cdkVirtualFor][cdkVirtualForOf]", inputs: ["cdkVirtualForOf", "cdkVirtualForTrackBy", "cdkVirtualForTemplate", "cdkVirtualForTemplateCacheSize"] }, { kind: "component", type: i8.CdkVirtualScrollViewport, selector: "cdk-virtual-scroll-viewport", inputs: ["orientation", "appendOnly"], outputs: ["scrolledIndexChange"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.1.5", ngImport: i0, type: CountrySelectComponent, decorators: [{
            type: Component,
            args: [{ selector: 'ng-country-select', standalone: true, imports: [
                        CommonModule,
                        ReactiveFormsModule,
...
//# sourceMappingURL=wlucha-ng-country-select.mjs.map
